...
!(function (t, i) {
  ...
  function a(t, n, a, c, u, f) {
    ...
    return Math.abs(g) >= 33306690738754716e-32 * y
      ...
      : -(function (t, n, a, c, u, f, _) {
          ...
          if (
            ((H =
              11093356479670487e-47 * _ + 33306690738754706e-32 * Math.abs(j)),
            (j += F * m + L * d - (K * y + U * g)),
            j >= H || -j >= H)
          )
            return j;
    ...
    update() {
      ...
      const P = (function (t, i, e, n, s, l) {
        const h = e - t,
          ...
          u = o * o + a * a,
          f = 0.5 / (h * a - r * o);
        return { x: t + (a * c - r * u) * f, y: i + (h * u - o * c) * f };
      })(v, b, T, M, k, $);
      ...
      for (let l, h, r = 0; r < this._ids.length; r++) {
        ...
        let _ = 0;
        for (
          let t = 0, i = this._hashKey(u, f);
          t < this._hashSize &&
          ((_ = s[(i + t) % this._hashSize]), -1 === _ || _ === e[_]);
          t++
        );
        _ = i[_];
        let d,
        ...
        for (
          ;
          (d = e[g]),
            a(u, f, t[2 * g], t[2 * g + 1], t[2 * d], t[2 * d + 1]) >= 0;
        ...
        for (
          ;
          (d = e[w]),
            a(u, f, t[2 * w], t[2 * w + 1], t[2 * d], t[2 * d + 1]) < 0;
        ...
        if (g === _)
          for (
            ;
            (d = i[g]),
              a(u, f, t[2 * d], t[2 * d + 1], t[2 * g], t[2 * g + 1]) < 0;
  ...
  function y(t, i, e, n) {
    if (n - e <= 20)
      ...
      (t[e + 1] = t[l]),
        (t[l] = h),
        n - s + 1 >= l - e
          ? (y(t, i, s, n), y(t, i, e, l - 1))
          : (y(t, i, e, l - 1), y(t, i, s, n));
    }
  }
  function m(t, i, e) {
    const n = t[i];
  ...
  class v {
    ...
    arc(t, i, e) {
      ...
      null === this._x1
        ? (this._ += `M${n},${s}`)
        : (Math.abs(this._x1 - n) > w || Math.abs(this._y1 - s) > w) &&
          (this._ += "L" + n + "," + s),
        e &&
          (this._ += `A${e},${e},0,1,1,${
            t - e
    ...
    *cellPolygons() {
    ...
    _renderSegment(t, i, e, n, s) {
      ...
      0 === h && 0 === r
        ...
        : (l = this._clipSegment(t, i, e, n, h, r)) &&
    ...
    *neighbors(t) {
    ...
    _clipSegment(t, i, e, n, s, l) {
      ...
      for (h && ([t, i, e, n, s, l] = [e, n, t, i, l, s]); ; ) {
        ...
        let r,
          ...
          a = s || l;
        8 & a
          ? ((r = t + ((e - t) * (this.ymax - i)) / (n - i)), (o = this.ymax))
          : 4 & a
          ? ((r = t + ((e - t) * (this.ymin - i)) / (n - i)), (o = this.ymin))
          : 2 & a
          ? ((o = i + ((n - i) * (this.xmax - t)) / (e - t)), (r = this.xmax))
          : ((o = i + ((n - i) * (this.xmin - t)) / (e - t)), (r = this.xmin)),
          s
            ? ((t = r), (i = o), (s = this._regioncode(t, i)))
            : ((e = r), (n = o), (l = this._regioncode(e, n)));
      }
    }
    _clipInfinite(t, i, e, n, s, l) {
      let h,
        r = Array.from(i);
      if (
        ((h = this._project(r[0], r[1], e, n)) && r.unshift(h[0], h[1]),
    ...
    _project(t, i, e, n) {
      ...
      if (n < 0) {
        ...
        (s = (this.ymin - i) / n) < r &&
          ((h = this.ymin), (l = t + (r = s) * e));
      } else if (n > 0) {
        if (i >= this.ymax) return null;
        (s = (this.ymax - i) / n) < r &&
          ((h = this.ymax), (l = t + (r = s) * e));
      }
      if (e > 0) {
        if (t >= this.xmax) return null;
        (s = (this.xmax - t) / e) < r &&
          ((l = this.xmax), (h = i + (r = s) * n));
      } else if (e < 0) {
        if (t <= this.xmin) return null;
        (s = (this.xmin - t) / e) < r &&
          ((l = this.xmin), (h = i + (r = s) * n));
      }
      return [l, h];
    }
    _edgecode(t, i) {
  ...
  class S {
        ...
        "length" in t
          ...
          : Float64Array.from(
              (function* (t, i, e, n) {
                let s = 0;
                for (const l of t)
                  yield i.call(n, l, s, t), yield e.call(n, l, s, t), ++s;
              })(t, i, e, n)
            )
      );
    }
    ...
    _init() {
      ...
      n.length <= 2 &&
        ...
        2 === n.length &&
          ((l[n[1]] = 0),
          (this.triangles[1] = n[1]),
          (this.triangles[2] = n[1])));
    }
    voronoi(t) {
      return new T(this, t);
    }
    *neighbors(t) {
      ...
      if (h) {
        const i = h.indexOf(t);
        return (
          i > 0 && (yield h[i - 1]), void (i < h.length - 1 && (yield h[i + 1]))
        );
      }
      const r = i[t];
      if (-1 === r) return;
    ...
    _step(t, i, e) {
      ...
      do {
        ...
        if (((f = h[f]), -1 === f)) {
          if (
            ((f = s[(l[t] + 1) % s.length]),
            f !== n && A(i - o[2 * f], 2) + A(e - o[2 * f + 1], 2) < c)
          )
            return f;
          break;
        }
